...
public interface UserSpotDAO {
     ...
     */
    boolean insert(Connection conn, Long userId, int spotId) throws SQLException;
     ...
     * @throws SQLException DB 처리 중 예외가 발생한 경우
     */
    boolean existsByUserIdAndSpotId(Connection conn, Long userId, int spotId) throws SQLException;
     ...
     * @throws SQLException DB 처리 중 예외가 발생한 경우
     */
    List<Integer> findSpotIdsByUserId(Connection conn, Long userId) throws SQLException;
}
